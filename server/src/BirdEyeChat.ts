...
@injectable()
export class BirdEyeChatBot extends KnightChatBot {
	protected _botRole = "followerBirdEye";
	...
	public SetLang(lang: { [key: string]: any }) {
		super.SetLang(lang);
		this.chatHelp.joinRaid = lang.chatHelp.joinRaid.BirdEye;
		this.chatResponses.joinRaid = lang.chatResponses.joinRaid.BirdEye;
	}
