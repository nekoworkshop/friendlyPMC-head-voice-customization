...
export const openZonesMap = {
	...
	sandbox: ["ZoneSandbox", "ZoneSandSnipeCenter"],
	shoreline: ["ZoneBunker", "ZoneBunkeSniper", "ZoneBusStation", "ZoneForestGasStation", "ZoneForestSpawn", "ZoneForestTruck", "ZoneGasStation", "ZoneGreenHouses", "ZoneIsland", "ZoneMeteoStation", "ZonePassClose", "ZonePassFar", "ZonePort", "ZonePowerStation", "ZonePowerStationSniper", "ZoneRailWays", "ZoneSanatorium1", "ZoneSanatorium2", "ZoneSmuglers", "ZoneStartVillage", "ZoneTunnel"],
	tarkovstreets: ["ZoneCard1", "ZoneCarShowroom", "ZoneCarShowroom_main_roof", "ZoneCinema", "ZoneClimova", "ZoneColumn", "ZoneConcordia_1", "ZoneConcordia_2", "ZoneConcordiaParking", "ZoneConstruction", "ZoneFactory", "ZoneHotel_1", "ZoneHotel_2", "ZoneMvd", "ZoneSnipeBuilding", "ZoneSnipeCarShowroom", "ZoneSnipeCinema", "ZoneSnipeSW01", "ZoneStilo", "ZoneSW00", "ZoneSW01"],
